...
var attractionsModule = (function () {
  ...
  var publicAPI = {
    ...
    getRestaurant: function(restaurants) {
      enhanced.restaurants = restaurants;
    },

    sendRestaurants: function() {
      // console.log("enhanced.hotels: ", enhanced.restaurants)
      return enhanced.restaurants;
    },
